      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 p-6 sm:p-8 shadow-2xl mb-6">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex flex-col sm:flex-row items-center gap-5 text-center sm:text-left">
            <Link href="/admin/leases" className="absolute top-0 left-0 sm:relative inline-flex items-center justify-center rounded-full text-slate-300 hover:text-white hover:bg-white/10 transition-colors h-10 w-10 shrink-0">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden flex flex-col h-full group">
          ...
          <div className="relative z-10 p-6 flex flex-col h-full">
            ...
            <div className={`mt-auto pt-4 border-t flex items-center justify-between ${coverPhoto ? 'border-white/20' : 'border-slate-100'}`}>
              ...
              <Link href={`/admin/properties/${lease.unit.property.id}`} className={`inline-flex items-center justify-center rounded-md text-xs font-bold transition-colors h-8 px-3 ${coverPhoto ? 'bg-white/20 hover:bg-white/30 text-white backdrop-blur-sm' : 'border border-slate-200 hover:bg-slate-100 text-slate-700'}`}>
                Ver Propiedad
              </Link>
            </div>
          </div>
