      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-1.5">RFC</label>
                <input 
                  type="text"
                  placeholder="Ej. AAA010101AAA"
                  className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white outline-none transition-all font-medium text-slate-900 focus:border-indigo-500 uppercase" 
                  value={formData.rfc}
                  onChange={e => setFormData({...formData, rfc: e.target.value.toUpperCase()})}
                />
              </div>
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-1.5">Régimen Fiscal (SAT)</label>
                <input 
                  type="text"
                  placeholder="Ej. 612"
                  className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white outline-none transition-all font-medium text-slate-900 focus:border-indigo-500" 
